...
List.prototype = {
    ...
    _command: function _command(value) {
        ...
        if($selectionElem.getNodeName()==='OL'){
            $selectionElem.css('list-style','decimal');
            $selectionElem.css('padding-left','10px;');
        }
         if($selectionElem.getNodeName()==='UL'){
            $selectionElem.css('list-style','disc');
            $selectionElem.css('padding-left','10px;');
        }
        $selectionElem.children().css('list-style','inherit');
         $selectionElem.children().css('display','list-item');
